...
export class PublicationService {
    ...
    getPublicationsByRestaurantId(
        restaurantId: string
    ): Observable<IpublicationId[]> {
        this.publicationsCollection = this.afs.collection<Ipublication>(
            'publications',
            ref =>
                ref
    ...
    savePublication(publication: IpublicationId): Observable<any> {
        const newPublication: Ipublication = this.buildPublicationInterface(
            publication
        );
